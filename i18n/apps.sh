...
APPLICATIONS['framework']='novius-os/framework';

APPLICATIONS['noviusos_page']='novius-os/framework/applications/noviusos_page';
...
APPLICATIONS['noviusos_news']='local/applications/noviusos_news';
APPLICATIONS['noviusos_form']='local/applications/noviusos_form';
